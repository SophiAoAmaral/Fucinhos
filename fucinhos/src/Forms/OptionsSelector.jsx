      ...
      <div className="flex flex-wrap md:flex-nowrap gap-3 md:gap-5 ">
        {options?.map((option) => (
          <button
            ...
            className={` ${value === option.value ? "bg-roxo/35 border border-roxo text-roxo-escuro/90" : "bg-white text-black border"} flex items-center justify-center md:justify-start font-nunito px-4 py-2 rounded-4xl w-[100%] md:w-auto gap-3 md:gap-6 ${erro ? "border-red-400" : "border-gray-300"}`}
          >
